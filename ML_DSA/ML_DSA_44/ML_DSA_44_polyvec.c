...
/*====================================================================================================================*/
/** \file ML_DSA_polyvec.c
* \brief  description of ML_DSA_polyvec
*
* \details
*
*
...
/**********************************************************************************************************************/
static void ML_DSA_44_Polyvecl_Pointwise_Acc_Montgomery(poly_D2 *const w, const polyvecl_D2 *const u,
...
/*====================================================================================================================*/
/**
* \brief Pointwise multiply vectors of polynomials of length L_ML_DSA_44, multiply resulting vector by 2^{-32}
                                                               ...
                                                               const polyvecl_D2 *const v)
{
  ...
  ML_DSA_44_Poly_PointwiseMontgomery(w, &u->vec[0], &v->vec[0]);
  for (i = 1; i < L_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_PointwiseMontgomery(&t, &u->vec[i], &v->vec[i]);
    ML_DSA_44_Poly_Add(w, w, &t);
  }
} // end: ML_DSA_44_Polyvecl_Pointwise_Acc_Montgomery
/**********************************************************************************************************************/
...
*
* \param[out] polyvecl_D2        mat[K_ML_DSA_44] :        output matrix
...
void ML_DSA_44_Polyvec_MatrixExpand(polyvecl_D2 mat[K_ML_DSA_44], const uint8 rho[SEEDBYTES_ML_DSA])
{
  ...
  {
    for (j = 0; j < L_ML_DSA_44; ++j)
    {
      ML_DSA_44_Poly_Uniform(&mat[i].vec[j], rho, (uint16)(((uint16)i << 8) + j));
    }
  }
} // end: ML_DSA_44_Polyvec_MatrixExpand
/*====================================================================================================================*/
/**
* \brief t.b.d
*
* \param[out] polyvecl_D2                       *t : t.b.d
* \param[in]  const polyvecl_D2  mat[K_ML_DSA_44] : t.b.d
                                                        ...
                                                        const polyvecl_D2 *const v)
{
  ...
  for (i = 0; i < K_ML_DSA_44; ++i)
  {
    ML_DSA_44_Polyvecl_Pointwise_Acc_Montgomery(&t->vec[i], &mat[i], v);
  }
} // end: ML_DSA_44_Polyvec_MatrixPointwiseMontgomery
/*====================================================================================================================*/
/**
* \brief t.b.d
*
...
void ML_DSA_44_Polyvecl_UniformEta(polyvecl_D2 *v, const uint8 seed[CRHBYTES_ML_DSA], uint16 nonce)
{
  ...
  {
    ML_DSA_44_Poly_UniformEta(&v->vec[i], seed, nonce_temp);
    nonce_temp++;
  }
} // end: ML_DSA_44_Polyvecl_UniformEta
/*====================================================================================================================*/
/**
* \brief t.b.d
*
...
void ML_DSA_44_Polyvecl_UniformGamma1(polyvecl_D2 *v, const uint8 seed[CRHBYTES_ML_DSA], uint16 nonce)
{
  ...
  for (i = 0; i < L_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_UniformGamma1(&v->vec[i], seed, (uint16)((L_ML_DSA_44 * nonce) + i));
  }
} // end: ML_DSA_44_Polyvecl_UniformGamma1
/*====================================================================================================================*/
/**
* \brief t.b.d
*
...
void ML_DSA_44_Polyvecl_Reduce(polyvecl_D2 *v)
{
  ...
  for (i = 0; i < L_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_Reduce(&v->vec[i]);
  }
} // end: ML_DSA_44_Polyvecl_Reduce
/*====================================================================================================================*/
/**
* \brief Add vectors of polynomials of length L_ML_DSA_44. No modular reduction is performed.
*
...
void ML_DSA_44_Polyvecl_Add(polyvecl_D2 *w, const polyvecl_D2 *const u, const polyvecl_D2 *const v)
{
  ...
  for (i = 0; i < L_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_Add(&w->vec[i], &u->vec[i], &v->vec[i]);
  }
} // end: ML_DSA_44_Polyvecl_Add
/*====================================================================================================================*/
/**
* \brief Forward NTT of all polynomials in vector of length L_ML_DSA_44.
...
void ML_DSA_44_Polyvecl_Ntt(polyvecl_D2 *v)
{
  ...
  for (i = 0; i < L_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_Ntt(&v->vec[i]);
  }
} // end: ML_DSA_44_Polyvecl_Ntt
/*====================================================================================================================*/
/**
* \brief t.b.d
*
...
void ML_DSA_44_Polyvecl_InvnttTomont(polyvecl_D2 *v)
{
  ...
  for (i = 0; i < L_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_InvnttTomont(&v->vec[i]);
  }
} // end: ML_DSA_44_Polyvecl_InvnttTomont
/*====================================================================================================================*/
/**
* \brief t.b.d
*
                                                       ...
                                                       const polyvecl_D2 *const v)
{
  ...
  for (i = 0; i < L_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_PointwiseMontgomery(&r->vec[i], a, &v->vec[i]);
  }
} // end: ML_DSA_44_Polyvecl_PointwisePolyMontgomery
/*====================================================================================================================*/
/**
* \brief Check infinity norm of polynomials in vector of length L_ML_DSA_44.
*              Assumes input polyvecl_D2 to be reduced by ML_DSA_44_Polyvecl_Reduce().
*
...
sint8 ML_DSA_44_Polyvecl_Chknorm(const polyvecl_D2 *const v, sint32 bound)
{
  ...
  for (i = 0; i < L_ML_DSA_44; ++i)
  {
    if (0 < ML_DSA_44_Poly_Chknorm(&v->vec[i], bound))
    {
      retVal = 1;
    }
  }
  ...
  return retVal;
} // end: ML_DSA_44_Polyvecl_Chknorm
/*====================================================================================================================*/
/**
* \brief t.b.d
*
...
} // end: ML_DSA_44_Polyveck_UniformEta
/*====================================================================================================================*/
/**
* \brief Reduce coefficients of polynomials in vector of length K_ML_DSA_44 to representatives in
*              [-6283008,6283008].
*
...
} // end: ML_DSA_44_Polyveck_Reduce
/*====================================================================================================================*/
/**
* \brief For all coefficients of polynomials in vector of length K_ML_DSA_44 add Q if coefficient is negative.
*
* \param[in,out] polyveck_D2 *v : pointer to input/output vector
*/
void ML_DSA_44_Polyveck_CAddQ(polyveck_D2 *v)
{
  ...
  for (i = 0; i < K_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_CAddQ(&v->vec[i]);
  }
} // end: ML_DSA_44_Polyveck_CAddQ
/*====================================================================================================================*/
/**
* \brief Add vectors of polynomials of length K_ML_DSA_44. No modular reduction is performed.
*
...
} // end: ML_DSA_44_Polyveck_Add
/*====================================================================================================================*/
/**
* \brief Subtract vectors of polynomials of length K_ML_DSA_44. No modular reduction is performed.
*
*  \param[in] polyveck_D2       *w : pointer to output vector
...
void ML_DSA_44_Polyveck_Sub(polyveck_D2 *w, const polyveck_D2 *const u, const polyveck_D2 *const v)
{
  ...
  for (i = 0; i < K_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_Sub(&w->vec[i], &u->vec[i], &v->vec[i]);
  }
} // end: ML_DSA_44_Polyveck_Sub
/*====================================================================================================================*/
/**
* \brief Multiply vector of polynomials of Length K_ML_DSA_44 by 2^D without modular reduction.
...
void ML_DSA_44_Polyveck_Shiftl(polyveck_D2 *v)
{
  ...
  for (i = 0; i < K_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_Shiftl(&v->vec[i]);
  }
} // end: ML_DSA_44_Polyveck_Shiftl
/*====================================================================================================================*/
/**
* \brief Forward NTT of all polynomials in vector of length K_ML_DSA_44.
*              Output coefficients can be up to 16*Q larger than input coefficients.
*
* \param[in,out] polyveck_D2 *v : pointer to input/output vector
*/
...
} // end: ML_DSA_44_Polyveck_Ntt
/*====================================================================================================================*/
/**
* \brief Inverse NTT and multiplication by 2^{32} of polynomials in vector of length K_ML_DSA_44.
...
} // end: ML_DSA_44_Polyveck_InvnttTomont
/*====================================================================================================================*/
/**
* \brief t.b.d
*
...
} // end: ML_DSA_44_Polyveck_PointwisePolyMontgomery
/*====================================================================================================================*/
/**
* \brief Check infinity norm of polynomials in vector of length K_ML_DSA_44.
*              Assumes input polyveck_D2to be reduced by ML_DSA_44_Polyveck_Reduce().
*
...
sint8 ML_DSA_44_Polyveck_Chknorm(const polyveck_D2 *const v, sint32 bound)
{
  ...
  return retVal;
} // end: ML_DSA_44_Polyveck_Chknorm
/*====================================================================================================================*/
/**
* \brief For all coefficients a of polynomials in vector of length K_ML_DSA_44, compute a0, a1 such that a
...
void ML_DSA_44_Polyveck_Power2Round(polyveck_D2 *v1, polyveck_D2 *v0, const polyveck_D2 *const v)
{
  ...
  for (i = 0; i < K_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_Power2Round(&v1->vec[i], &v0->vec[i], &v->vec[i]);
  }
} // end: ML_DSA_44_Polyveck_Power2Round
/*====================================================================================================================*/
/**
* \brief For all coefficients a of polynomials in vector of length K_ML_DSA_44, compute high and low bits
...
void ML_DSA_44_Polyveck_Decompose(polyveck_D2 *v1, polyveck_D2 *v0, const polyveck_D2 *const v)
{
  ...
  for (i = 0; i < K_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_Decompose(&v1->vec[i], &v0->vec[i], &v->vec[i]);
  }
} // end: ML_DSA_44_Polyveck_Decompose
/*====================================================================================================================*/
/**
...
uint32 ML_DSA_44_Polyveck_MakeHint(polyveck_D2 *h, const polyveck_D2 *const v0, const polyveck_D2 *const v1)
{
  ...
  for (i = 0; i < K_ML_DSA_44; ++i)
  {
    s += ML_DSA_44_Poly_MakeHint(&h->vec[i], &v0->vec[i], &v1->vec[i]);
  }

  return s;
} // end: ML_DSA_44_Polyveck_MakeHint
/*====================================================================================================================*/
/**
...
void ML_DSA_44_Polyveck_UseHint(polyveck_D2 *w, const polyveck_D2 *const v, const polyveck_D2 *const h)
{
  ...
  for (i = 0; i < K_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_UseHint(&w->vec[i], &v->vec[i], &h->vec[i]);
  }
} // end: ML_DSA_44_Polyveck_UseHint
/*====================================================================================================================*/
/**
* \brief t.b.d
*
* \param[out] uint8 r[K_ML_DSA_44 * POLYW1_PACKEDBYTES_ML_DSA_44] : t.b.d
                                      ...
                                      const polyveck_D2 *const w1)
{
  ...
  for (i = 0; i < K_ML_DSA_44; ++i)
  {
    ML_DSA_44_Poly_W1Pack(&r[i * POLYW1_PACKEDBYTES_ML_DSA_44], &w1->vec[i]);
  }
} // end: ML_DSA_44_Polyveck_PackW1
