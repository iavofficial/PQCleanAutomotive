...
/*====================================================================================================================*/
/** \file ML_DSA_65_rounding.c
* \brief  description of ML_DSA_65_rounding.c
*
* \details
*
*
...
uint8 ML_DSA_65_MakeHint(sint32 a0, sint32 a1)
{
  ...
  if ((a0 > GAMMA2_ML_DSA_65) || (a0 < -GAMMA2_ML_DSA_65) || (((a0 == -GAMMA2_ML_DSA_65) && (a1 != 0)) != 0))
  {
    retVal = 1;
  }

  return retVal;
} // end: ML_DSA_65_MakeHint
/*====================================================================================================================*/
/**
