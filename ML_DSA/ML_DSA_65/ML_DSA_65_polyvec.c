...
/*====================================================================================================================*/
/** \file ML_DSA_65_polyvec.c
* \brief  description of ML_DSA_65_polyvec.c
*
* \details
*
*
...
/**********************************************************************************************************************/
static void ML_DSA_65_Polyvecl_Pointwise_Acc_Montgomery(poly_D3 *const w, const polyvecl_D3 *const u,
...
/*====================================================================================================================*/
/**
* \brief Pointwise multiply vectors of polynomials of length L_ML_DSA_65, multiply resulting vector by 2^{-32}
                                                               ...
                                                               const polyvecl_D3 *const v)
{
  ...
  ML_DSA_65_Poly_PointwiseMontgomery(w, &u->vec[0], &v->vec[0]);
  for (i = 1; i < L_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_PointwiseMontgomery(&t, &u->vec[i], &v->vec[i]);
    ML_DSA_65_Poly_Add(w, w, &t);
  }
} // end: ML_DSA_65_Polyvecl_Pointwise_Acc_Montgomery
/**********************************************************************************************************************/
...
*
* \param[out] polyvecl_D3        mat[K_ML_DSA_65] : output matrix
...
void ML_DSA_65_Polyvec_MatrixExpand(polyvecl_D3 mat[K_ML_DSA_65], const uint8 rho[SEEDBYTES_ML_DSA])
{
  ...
  {
    for (j = 0; j < L_ML_DSA_65; ++j)
    {
      ML_DSA_65_Poly_Uniform(&mat[i].vec[j], rho, (uint16)(((uint16)i << 8) + j));
    }
  }
} // end: ML_DSA_65_Polyvec_MatrixExpand
/*====================================================================================================================*/
/**
* \brief t.b.d
*
* \param[out] polyvecl_D3                      *t : t.b.d
* \param[in]  const polyvecl_D3 mat[K_ML_DSA_65] : t.b.d
                                                        ...
                                                        const polyvecl_D3 *const v)
{
  ...
  for (i = 0; i < K_ML_DSA_65; ++i)
  {
    ML_DSA_65_Polyvecl_Pointwise_Acc_Montgomery(&t->vec[i], &mat[i], v);
  }
} // end: ML_DSA_65_Polyvec_MatrixPointwiseMontgomery
/*====================================================================================================================*/
/**
* \brief t.b.d
*
...
void ML_DSA_65_Polyvecl_UniformEta(polyvecl_D3 *v, const uint8 seed[CRHBYTES_ML_DSA], uint16 nonce)
{
  ...
  {
    ML_DSA_65_Poly_UniformEta(&v->vec[i], seed, nonce_temp);
    nonce_temp++;
  }
} // end: ML_DSA_65_Polyvecl_UniformEta
/*====================================================================================================================*/
/**
* \brief t.b.d
*
...
void ML_DSA_65_Polyvecl_UniformGamma1(polyvecl_D3 *v, const uint8 seed[CRHBYTES_ML_DSA], uint16 nonce)
{
  ...
  for (i = 0; i < L_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_UniformGamma1(&v->vec[i], seed, (uint16)((L_ML_DSA_65 * nonce) + i));
  }
} // end: ML_DSA_65_Polyvecl_UniformGamma1
/*====================================================================================================================*/
/**
* \brief t.b.d
*
...
void ML_DSA_65_Polyvecl_Reduce(polyvecl_D3 *v)
{
  ...
  for (i = 0; i < L_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_Reduce(&v->vec[i]);
  }
} // end: ML_DSA_65_Polyvecl_Reduce
/*====================================================================================================================*/
/**
* \brief Add vectors of polynomials of length L_ML_DSA_65. No modular reduction is performed.
*
...
void ML_DSA_65_Polyvecl_Add(polyvecl_D3 *w, const polyvecl_D3 *const u, const polyvecl_D3 *const v)
{
  ...
  for (i = 0; i < L_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_Add(&w->vec[i], &u->vec[i], &v->vec[i]);
  }
} // end: ML_DSA_65_Polyvecl_Add
/*====================================================================================================================*/
/**
* \brief Forward NTT of all polynomials in vector of length L_ML_DSA_65.
...
void ML_DSA_65_Polyvecl_Ntt(polyvecl_D3 *v)
{
  ...
  for (i = 0; i < L_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_Ntt(&v->vec[i]);
  }
} // end: ML_DSA_65_Polyvecl_Ntt
/*====================================================================================================================*/
/**
* \brief t.b.d
*
...
void ML_DSA_65_Polyvecl_InvnttTomont(polyvecl_D3 *v)
{
  ...
  for (i = 0; i < L_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_InvnttTomont(&v->vec[i]);
  }
} // end: ML_DSA_65_Polyvecl_InvnttTomont
/*====================================================================================================================*/
/**
* \brief t.b.d
*
                                                       ...
                                                       const polyvecl_D3 *const v)
{
  ...
  for (i = 0; i < L_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_PointwiseMontgomery(&r->vec[i], a, &v->vec[i]);
  }
} // end: ML_DSA_65_Polyvecl_PointwisePolyMontgomery
/*====================================================================================================================*/
/**
* \brief Check infinity norm of polynomials in vector of length L_ML_DSA_65.
*              Assumes input polyvecl_D3 to be reduced by ML_DSA_65_Polyvecl_Reduce().
*
...
sint8 ML_DSA_65_Polyvecl_Chknorm(const polyvecl_D3 *const v, sint32 bound)
{
  ...
  for (i = 0; i < L_ML_DSA_65; ++i)
  {
    if (0 < ML_DSA_65_Poly_Chknorm(&v->vec[i], bound))
    {
      retVal = 1;
    }
  }
  ...
  return retVal;
} // end: ML_DSA_65_Polyvecl_Chknorm
/*====================================================================================================================*/
/**
* \brief t.b.d
*
...
} // end: ML_DSA_65_Polyveck_UniformEta
/*====================================================================================================================*/
/**
* \brief Reduce coefficients of polynomials in vector of length K_ML_DSA_65 to representatives in
*              [-6283008,6283008].
*
...
} // end: ML_DSA_65_Polyveck_Reduce
/*====================================================================================================================*/
/**
* \brief For all coefficients of polynomials in vector of length K_ML_DSA_65 add Q if coefficient is negative.
*
* \param[in,out] polyveck_D3 *v : pointer to input/output vector
*/
void ML_DSA_65_Polyveck_CAddQ(polyveck_D3 *v)
{
  ...
  for (i = 0; i < K_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_CAddQ(&v->vec[i]);
  }
} // end: ML_DSA_65_Polyveck_CAddQ
/*====================================================================================================================*/
/**
* \brief Add vectors of polynomials of length K_ML_DSA_65. No modular reduction is performed.
*
...
} // end: ML_DSA_65_Polyveck_Add
/*====================================================================================================================*/
/**
* \brief Subtract vectors of polynomials of length K_ML_DSA_65. No modular reduction is performed.
*
* \param[out] polyveck_D3       *w : pointer to output vector
...
void ML_DSA_65_Polyveck_Sub(polyveck_D3 *w, const polyveck_D3 *const u, const polyveck_D3 *const v)
{
  ...
  for (i = 0; i < K_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_Sub(&w->vec[i], &u->vec[i], &v->vec[i]);
  }
} // end: ML_DSA_65_Polyveck_Sub
/*====================================================================================================================*/
/**
* \brief Multiply vector of polynomials of Length K_ML_DSA_65 by 2^D without modular reduction.
...
void ML_DSA_65_Polyveck_Shiftl(polyveck_D3 *v)
{
  ...
  for (i = 0; i < K_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_Shiftl(&v->vec[i]);
  }
} // end: ML_DSA_65_Polyveck_Shiftl
/*====================================================================================================================*/
/**
* \brief Forward NTT of all polynomials in vector of length K_ML_DSA_65.
*              Output coefficients can be up to 16*Q larger than input coefficients.
*
* \param[in,out] polyveck_D3 *v : pointer to input/output vector
*/
...
} // end: ML_DSA_65_Polyveck_Ntt
/*====================================================================================================================*/
/**
* \brief Inverse NTT and multiplication by 2^{32} of polynomials in vector of length K_ML_DSA_65.
...
} // end: ML_DSA_65_Polyveck_InvnttTomont
/*====================================================================================================================*/
/**
* \brief t.b.d
*
...
} // end: ML_DSA_65_Polyveck_PointwisePolyMontgomery
/*====================================================================================================================*/
/**
* \brief Check infinity norm of polynomials in vector of length K_ML_DSA_65.
*              Assumes input polyveck_D3to be reduced by ML_DSA_65_Polyveck_Reduce().
*
...
sint8 ML_DSA_65_Polyveck_Chknorm(const polyveck_D3 *const v, sint32 bound)
{
  ...
  return retVal;
} // end: ML_DSA_65_Polyveck_Chknorm
/*====================================================================================================================*/
/**
* \brief For all coefficients a of polynomials in vector of length K_ML_DSA_65, compute a0, a1 such that a
...
void ML_DSA_65_Polyveck_Power2Round(polyveck_D3 *v1, polyveck_D3 *v0, const polyveck_D3 *const v)
{
  ...
  for (i = 0; i < K_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_Power2Round(&v1->vec[i], &v0->vec[i], &v->vec[i]);
  }
} // end: ML_DSA_65_Polyveck_Power2Round
/*====================================================================================================================*/
/**
* \brief For all coefficients a of polynomials in vector of length K_ML_DSA_65, compute high and low bits
...
void ML_DSA_65_Polyveck_Decompose(polyveck_D3 *v1, polyveck_D3 *v0, const polyveck_D3 *const v)
{
  ...
  for (i = 0; i < K_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_Decompose(&v1->vec[i], &v0->vec[i], &v->vec[i]);
  }
} // end: ML_DSA_65_Polyveck_Decompose
/*====================================================================================================================*/
/**
...
uint32 ML_DSA_65_Polyveck_MakeHint(polyveck_D3 *h, const polyveck_D3 *const v0, const polyveck_D3 *const v1)
{
  ...
  for (i = 0; i < K_ML_DSA_65; ++i)
  {
    s += ML_DSA_65_Poly_MakeHint(&h->vec[i], &v0->vec[i], &v1->vec[i]);
  }

  return s;
} // end: ML_DSA_65_Polyveck_MakeHint
/*====================================================================================================================*/
/**
...
void ML_DSA_65_Polyveck_UseHint(polyveck_D3 *w, const polyveck_D3 *const v, const polyveck_D3 *const h)
{
  ...
  for (i = 0; i < K_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_UseHint(&w->vec[i], &v->vec[i], &h->vec[i]);
  }
} // end: ML_DSA_65_Polyveck_UseHint
/*====================================================================================================================*/
/**
* \brief t.b.d
*
* \param[out] uint8 r[K_ML_DSA_65 * POLYW1_PACKEDBYTES_ML_DSA_65] : t.b.d
                                      ...
                                      const polyveck_D3 *const w1)
{
  ...
  for (i = 0; i < K_ML_DSA_65; ++i)
  {
    ML_DSA_65_Poly_W1Pack(&r[i * POLYW1_PACKEDBYTES_ML_DSA_65], &w1->vec[i]);
  }
} // end: ML_DSA_65_Polyveck_PackW1
