...
/*====================================================================================================================*/
/** \file Hqc256_hqc.c
* \brief  Implementation of Hqc256_hqc.h
*
* \details
*
*
...
void Hqc256_Pke_Keygen(uint8 *const pk, uint8 *const sk)
{
  ...
  Hqc256_Vect_Mul(s, y, h);
  Hqc256_Vect_Add(s, x, s, HQC256_VEC_N_SIZE_64);

  // Parse keys to string
  Hqc256_Public_Key_To_String(pk, pk_seed, s);
  Hqc256_Secret_Key_To_String(sk, sk_seed, sigma, pk);
} // end: Hqc256_Pke_Keygen
                              ...
                              const uint8 *const pk)
{
  ...
  Hqc256_SeedExpander_Init(&vec_seedexpander, theta, HQC256_SEED_BYTES);

  // Retrieve h and s from public key
  Hqc256_Public_Key_From_String(h, s, pk);

  // Generate r1, r2 and e
  Hqc256_Vect_Set_Random_Fixed_Weight(&vec_seedexpander, r1, HQC256_PARAM_OMEGA_R);
  Hqc256_Vect_Set_Random_Fixed_Weight(&vec_seedexpander, r2, HQC256_PARAM_OMEGA_R);
  Hqc256_Vect_Set_Random_Fixed_Weight(&vec_seedexpander, e, HQC256_PARAM_OMEGA_E);

  // Compute u = r1 + r2.h
  Hqc256_Vect_Mul(u, r2, h);
  Hqc256_Vect_Add(u, r1, u, HQC256_VEC_N_SIZE_64);
  ...
  Hqc256_Vect_Mul(tmp2, r2, s);
  Hqc256_Vect_Add(tmp2, e, tmp2, HQC256_VEC_N_SIZE_64);
  Hqc256_Vect_Add(tmp2, tmp1, tmp2, HQC256_VEC_N_SIZE_64);
  Hqc256_Vect_Resize(v, HQC256_PARAM_N1N2, tmp2, HQC256_PARAM_N);
} // end: Hqc256_Pke_Encrypt
                               ...
                               const uint8 *const sk)
{
  ...
  Hqc256_Secret_Key_From_String(x, y, sigma, pk, sk);

  // Compute v - u.y
  Hqc256_Vect_Resize(tmp1, HQC256_PARAM_N, v, HQC256_PARAM_N1N2);
  Hqc256_Vect_Mul(tmp2, y, u);
  Hqc256_Vect_Add(tmp2, tmp1, tmp2, HQC256_VEC_N_SIZE_64);
