                                           ...
                                           const uint32 addr[8])
{
  ...
  FsmSw_CommonLib_MemCpy(buf, ctx->pub_seed, SLH_DSA_SHAKE_192SSIMPLE_N);
  FsmSw_CommonLib_MemCpy(&buf[SLH_DSA_SHAKE_192SSIMPLE_N], addr, SLH_DSA_SHAKE_192SSIMPLE_ADDR_BYTES);
  FsmSw_CommonLib_MemCpy(&buf[SLH_DSA_SHAKE_192SSIMPLE_N + SLH_DSA_SHAKE_192SSIMPLE_ADDR_BYTES], ctx->sk_seed,
                         SLH_DSA_SHAKE_192SSIMPLE_N);

  FsmSw_Fips202_Shake256(out, SLH_DSA_SHAKE_192SSIMPLE_N, buf,
                                                    ...
                                                    const slh_dsa_shake_192s_ctx *const ctx)
{
  ...
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, sk_prf, SLH_DSA_SHAKE_192SSIMPLE_N);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, optrand, SLH_DSA_SHAKE_192SSIMPLE_N);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, m, mlen);
  FsmSw_Fips202_Shake256_IncFinalize(&s_inc);
  FsmSw_Fips202_Shake256_IncSqueeze(R, SLH_DSA_SHAKE_192SSIMPLE_N, &s_inc);
                                               ...
                                               uint32 mlen, const slh_dsa_shake_192s_ctx *const ctx)
{
  ...
  FsmSw_Fips202_Shake256_IncInit(&s_inc);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, R, SLH_DSA_SHAKE_192SSIMPLE_N);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, pk, SLH_DSA_SHAKE_192SSIMPLE_PK_BYTES);
  FsmSw_Fips202_Shake256_IncAbsorb(&s_inc, m, mlen);
  FsmSw_Fips202_Shake256_IncFinalize(&s_inc);
  FsmSw_Fips202_Shake256_IncSqueeze(buf, SPX_DGST_BYTES, &s_inc);

  FsmSw_CommonLib_MemCpy(digest, bufp, SLH_DSA_SHAKE_192SSIMPLE_FORS_MSG_BYTES);
