...
/*====================================================================================================================*/
/** \file SLH_DSA_SHA2_192fSimple_context_sha2.c
* \brief  description of SLH_DSA_SHA2_192fSimple_context_sha2.c
*
* \details
*
*
...
/**********************************************************************************************************************/
static void slh_dsa_sha2_192fsimple_SeedState(slh_dsa_sha2_192f_ctx *ctx);
/**********************************************************************************************************************/
 ...
 *        and state_seeded_512, which can then be reused in SLH_DSA_SHA2_192fSimple_Thash
 *
...
static void slh_dsa_sha2_192fsimple_SeedState(slh_dsa_sha2_192f_ctx *ctx)
{
  ...
  for (i = SLH_DSA_SHA2_192FSIMPLE_N; i < SLH_DSA_SHA512_BLOCK_BYTES; ++i)
  {
    block[i] = 0;
  }
...
} // end: slh_dsa_sha2_192fsimple_SeedState
/**********************************************************************************************************************/
...
{
  slh_dsa_sha2_192fsimple_SeedState(ctx);
} // end: SLH_DSA_SHA2_192fSimple_InitializeHashFunction
