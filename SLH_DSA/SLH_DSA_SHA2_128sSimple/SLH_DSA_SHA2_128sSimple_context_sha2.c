 ...
 ** @{ */
/** \addtogroup SLH_DSA_SHA2_128sSimple_context
 ** @{ */

/*====================================================================================================================*/
/** \file SLH_DSA_SHA2_128sSimple_context_sha2.c
* \brief  description of SLH_DSA_SHA2_128sSimple_context_sha2.c
*
* \details
*
*
...
/**********************************************************************************************************************/
static void slh_dsa_sha2_128ssimple_SeedState(slh_dsa_sha2_128s_ctx *ctx);
/**********************************************************************************************************************/
 ...
 *        and state_seeded_512, which can then be reused in SLH_DSA_SHA2_128sSimple_Thash.
 *
 * \param[in] slh_dsa_sha2_128s_ctx *ctx : t.b.d.
 *
 */
static void slh_dsa_sha2_128ssimple_SeedState(slh_dsa_sha2_128s_ctx *ctx)
{
  ...
  for (i = SLH_DSA_SHA2_128SSIMPLE_N; i < SLH_DSA_SHA512_BLOCK_BYTES; ++i)
  {
    block[i] = 0;
  }
 ...
 *
 */
void SLH_DSA_SHA2_128sSimple_InitializeHashFunction(slh_dsa_sha2_128s_ctx *const ctx)
{
  slh_dsa_sha2_128ssimple_SeedState(ctx);
} // end: SLH_DSA_SHA2_128sSimple_InitializeHashFunction
