 ...
 ** @{ */
/** \addtogroup SLH_DSA_SHA2_192sSimple_thash
 ** @{ */

/*====================================================================================================================*/
/** \file SLH_DSA_SHA2_192sSimple_thash_sha2_simple.c
* \brief  description of SLH_DSA_SHA2_192sSimple_thash_sha2_simple.c
*
* \details
*
*
...
/*====================================================================================================================*/
/** 
 * \brief Takes an array of inblocks concatenated arrays of SLH_DSA_SHA2_192SSIMPLE_N bytes.
 *
 ...
 *
 */
void SLH_DSA_SHA2_192sSimple_Thash(uint8 *const out, const uint8 *const in, uint32 inblocks,
                                        const slh_dsa_sha2_192s_ctx *const ctx, const uint32 addr[8])
{

  uint8 outbuf[SLH_DSA_SHA256_OUTPUT_BYTES] = {0};
  sha256ctx sha2_state                            = {{0}};
  uint8 buf[SPX_SHA256_ADDR_BYTES + (SLH_DSA_SHA2_192SSIMPLE_THASH_BUF_LEN * SLH_DSA_SHA2_192SSIMPLE_N)] = {
      0};
