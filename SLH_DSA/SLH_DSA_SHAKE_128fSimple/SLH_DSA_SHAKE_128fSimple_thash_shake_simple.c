 ...
 ** @{ */
/** \addtogroup SLH_DSA_SHAKE_128fSimple_thash
 ** @{ */

/*====================================================================================================================*/
/** \file SLH_DSA_SHAKE_128fSimple_thash_shake_simple.c
* \brief  description of SLH_DSA_SHAKE_128fSimple_thash_shake_simple.c
*
* \details
*
*
...
/*====================================================================================================================*/
/**
 * \brief Takes an array of inblocks concatenated arrays of SLH_DSA_SHAKE_128FSIMPLE_N bytes.
 *
 ...
 */
void SLH_DSA_SHAKE_128fSimple_Thash(uint8 *const out, const uint8 *const in, uint32 inblocks,
                                         const slh_dsa_shake_128f_ctx *const ctx, const uint32 addr[8])
{
