                                           ...
                                           const uint32 addr[8])
{
  ...
  SLH_DSA_CommonLib_MemCpy(&buf[SLH_DSA_SHAKE_128FSIMPLE_N + SLH_DSA_SHAKE_128FSIMPLE_ADDR_BYTES], ctx->sk_seed,
                                                    ...
                                                    const slh_dsa_shake_128f_ctx *const ctx)
{
  ...
  SLH_DSA_Fips202_Shake256_IncAbsorb(&s_inc, sk_prf, SLH_DSA_SHAKE_128FSIMPLE_N);
  SLH_DSA_Fips202_Shake256_IncAbsorb(&s_inc, optrand, SLH_DSA_SHAKE_128FSIMPLE_N);
  SLH_DSA_Fips202_Shake256_IncAbsorb(&s_inc, m, mlen);
  SLH_DSA_Fips202_Shake256_IncFinalize(&s_inc);
  SLH_DSA_Fips202_Shake256_IncSqueeze(R, SLH_DSA_SHAKE_128FSIMPLE_N, &s_inc);
                                               ...
                                               uint32 mlen, const slh_dsa_shake_128f_ctx *const ctx)
{
  ...
  SLH_DSA_Fips202_Shake256_IncInit(&s_inc);
  SLH_DSA_Fips202_Shake256_IncAbsorb(&s_inc, R, SLH_DSA_SHAKE_128FSIMPLE_N);
  SLH_DSA_Fips202_Shake256_IncAbsorb(&s_inc, pk, SLH_DSA_SHAKE_128FSIMPLE_PK_BYTES);
  SLH_DSA_Fips202_Shake256_IncAbsorb(&s_inc, m, mlen);
  SLH_DSA_Fips202_Shake256_IncFinalize(&s_inc);
  SLH_DSA_Fips202_Shake256_IncSqueeze(buf, SPX_DGST_BYTES, &s_inc);

  SLH_DSA_CommonLib_MemCpy(digest, bufp, SLH_DSA_SHAKE_128FSIMPLE_FORS_MSG_BYTES);
