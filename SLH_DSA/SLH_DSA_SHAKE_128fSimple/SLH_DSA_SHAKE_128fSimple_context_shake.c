...
/*====================================================================================================================*/
/** \file SLH_DSA_SHAKE_128fSimple_context_shake.c
* \brief  description of SLH_DSA_SHAKE_128fSimple_context_shake.c
*
* \details
*
*
...
*
* \param[out] slh_dsa_shake_128f_ctx *ctx : t.b.d
*
*/
...
} // end: SLH_DSA_SHAKE_128fSimple_InitializeHashFunction
...
{
  (void)ctx;
} // end: SLH_DSA_SHAKE_128fSimple_1FreeHashFunction
