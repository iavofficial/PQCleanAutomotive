...
/*====================================================================================================================*/
/** \file SLH_DSA_SHA2_256sSimple_context_sha2.c
* \brief  description of SLH_DSA_SHA2_256sSimple_context_sha2.c
*
* \details
*
*
...
/**********************************************************************************************************************/
static void slh_dsa_sha2_256ssimple_SeedState(slh_dsa_sha2_256s_ctx *ctx);
/**********************************************************************************************************************/
 ...
 *        and state_seeded_512, which can then be reused in SLH_DSA_SHA2_256sSimple_Thash
 *
 * \param[in] slh_dsa_sha2_256s_ctx *ctx: t.b.d.
 *
 *
 */
static void slh_dsa_sha2_256ssimple_SeedState(slh_dsa_sha2_256s_ctx *ctx)
{
  ...
  for (i = SLH_DSA_SHA2_256SSIMPLE_N; i < SLH_DSA_SHA512_BLOCK_BYTES; ++i)
  {
    block[i] = 0;
  }
...
} // end: slh_dsa_sha2_256ssimple_SeedState
/**********************************************************************************************************************/
...
{
  slh_dsa_sha2_256ssimple_SeedState(ctx);
} // end: SLH_DSA_SHA2_256sSimple_InitializeHashFunction
