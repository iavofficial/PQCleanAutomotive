 ...
 ** @{ */
/** \addtogroup SLH_DSA_SHAKE_256fSimple_thash
 ** @{ */

/*====================================================================================================================*/
/** \file SLH_DSA_SHAKE_256fSimple_thash_shake_simple.c
* \brief  description of SLH_DSA_SHAKE_256fSimple_thash_shake_simple.c
*
* \details
*
*
...
/*====================================================================================================================*/
/**
 * \brief Takes an array of inblocks concatenated arrays of SLH_DSA_SHAKE_256FSIMPLE_N bytes.
 *
 ...
 *
 */
void SLH_DSA_SHAKE_256fSimple_Thash(uint8 *const out, const uint8 *const in, uint32 inblocks,
                                         const slh_dsa_shake_256f_ctx *const ctx, const uint32 addr[8])
{
  uint8 buf[SLH_DSA_SHAKE_256FSIMPLE_N + SLH_DSA_SHAKE_256FSIMPLE_ADDR_BYTES +
            (SLH_DSA_SHAKE_256FSIMPLE_THASH_BUF_LEN * SLH_DSA_SHAKE_256FSIMPLE_N)] = {0};
  ...
  SLH_DSA_CommonLib_MemCpy(&buf[SLH_DSA_SHAKE_256FSIMPLE_N + SLH_DSA_SHAKE_256FSIMPLE_ADDR_BYTES], in,
                         inblocks * SLH_DSA_SHAKE_256FSIMPLE_N);

  SLH_DSA_Fips202_Shake256(out, SLH_DSA_SHAKE_256FSIMPLE_N, buf,
                         SLH_DSA_SHAKE_256FSIMPLE_N + SLH_DSA_SHAKE_256FSIMPLE_ADDR_BYTES +
                             (inblocks * SLH_DSA_SHAKE_256FSIMPLE_N));
} // end: SLH_DSA_SHAKE_256fSimple_Thash
