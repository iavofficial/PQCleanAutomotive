 ...
 ** @{ */
/** \addtogroup SLH_DSA_SHAKE_256fSimple_hash
 ** @{ */

/*====================================================================================================================*/
/** \file SLH_DSA_SHAKE_256fSimple_hash_shake.c
* \brief  description of SLH_DSA_SHAKE_256fSimple_hash_shake.c
*
* \details
*
*
...
/* DEFINES                                                                                                            */
/**********************************************************************************************************************/
#define SPX_TREE_BITS  (SLH_DSA_SHAKE_256FSIMPLE_TREE_HEIGHT * (SLH_DSA_SHAKE_256FSIMPLE_D - 1u))
#define SPX_TREE_BYTES ((SPX_TREE_BITS + 7u) / 8u)
#define SPX_LEAF_BITS  SLH_DSA_SHAKE_256FSIMPLE_TREE_HEIGHT
#define SPX_LEAF_BYTES ((SPX_LEAF_BITS + 7u) / 8u)
#define SPX_DGST_BYTES (SLH_DSA_SHAKE_256FSIMPLE_FORS_MSG_BYTES + SPX_TREE_BYTES + SPX_LEAF_BYTES)
/**********************************************************************************************************************/
/* TYPES                                                                                                              */
/**********************************************************************************************************************/
 ...
 *
 */
void SLH_DSA_SHAKE_256fSimple_PrfAddr(uint8 *const out, const slh_dsa_shake_256f_ctx *const ctx,
                                           const uint32 addr[8])
{
 ...
 *
 */
void SLH_DSA_SHAKE_256fSimple_GenMessageRandom(uint8 *const R, const uint8 *const sk_prf,
 ...
 *
 */
void SLH_DSA_SHAKE_256fSimple_HashMessage(uint8 *const digest, uint64 *const tree, uint32 *const leaf_idx,
                                               const uint8 *const R, const uint8 *const pk, const uint8 *const m,
                                               uint32 mlen, const slh_dsa_shake_256f_ctx *const ctx)
{
  (void)ctx;
...
} // end: SLH_DSA_SHAKE_256fSimple_HashMessage
