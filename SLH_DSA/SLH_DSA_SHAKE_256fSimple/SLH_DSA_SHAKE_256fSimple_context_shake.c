...
/*====================================================================================================================*/
/** \file SLH_DSA_SHAKE_256fSimple_context_shake.c
* \brief  description of SLH_DSA_SHAKE_256fSimple_context_shake.c
*
* \details
*
*
...
*        operation.
*
* \param[out] slh_dsa_shake_256f_ctx *ctx : t.b.d.
*
*/
...
} // end: SLH_DSA_SHAKE_256fSimple_InitializeHashFunction
...
{
  (void)ctx;
} // end: SLH_DSA_SHAKE_256fSimple_1FreeHashFunction
