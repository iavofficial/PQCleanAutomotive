 ...
 ** @{ */
/** \addtogroup SLH_DSA_SHAKE_256fSimple_context
 ** @{ */

/*====================================================================================================================*/
/** \file SLH_DSA_SHAKE_256fSimple_context.h
* \brief  Description of SLH_DSA_SHAKE_256fSimple_context.h
*
* \details
*
*
 ...
 *
 **********************************************************************************************************************/
#ifndef SLH_DSA_SHAKE_256FSIMPLE_CONTEXT_H
#define SLH_DSA_SHAKE_256FSIMPLE_CONTEXT_H
/**********************************************************************************************************************/
/* INCLUDES                                                                                                           */
/**********************************************************************************************************************/
...
typedef struct
{
  uint8 pub_seed[SLH_DSA_SHAKE_256FSIMPLE_N];
  uint8 sk_seed[SLH_DSA_SHAKE_256FSIMPLE_N];

} slh_dsa_shake_256f_ctx;
/**********************************************************************************************************************/
/* GLOBAL VARIABLES                                                                                                   */
/**********************************************************************************************************************/
...
/**********************************************************************************************************************/
void SLH_DSA_SHAKE_256fSimple_InitializeHashFunction(slh_dsa_shake_256f_ctx *const ctx);

void SLH_DSA_SHAKE_256fSimple_1FreeHashFunction(slh_dsa_shake_256f_ctx *const ctx);

#endif /* SLH_DSA_SHAKE_256FSIMPLE_CONTEXT_H */
