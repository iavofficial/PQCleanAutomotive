                                                                  ...
                                                                  const uint8 *const seed)
{
  ...
  FsmSw_CommonLib_MemCpy(sk, seed, SLH_DSA_SHAKE_256FSIMPLE_CRYPTO_SEEDBYTES);

  FsmSw_CommonLib_MemCpy(pk, &sk[2u * SLH_DSA_SHAKE_256FSIMPLE_N], SLH_DSA_SHAKE_256FSIMPLE_N);

  FsmSw_CommonLib_MemCpy(ctx.pub_seed, pk, SLH_DSA_SHAKE_256FSIMPLE_N);
  FsmSw_CommonLib_MemCpy(ctx.sk_seed, sk, SLH_DSA_SHAKE_256FSIMPLE_N);
  ...
  FsmSw_CommonLib_MemCpy(&pk[SLH_DSA_SHAKE_256FSIMPLE_N], &sk[3u * SLH_DSA_SHAKE_256FSIMPLE_N],
...
void SLH_DSA_SHAKE_256fSimple_Crypto_Sign_KeyPair(uint8 *const pk, uint8 *const sk)
{
  ...
  (void)FsmSw_CommonLib_RandomBytes(seed, SLH_DSA_SHAKE_256FSIMPLE_CRYPTO_SEEDBYTES);
                                                         ...
                                                         uint32 mlen, const uint8 *const sk)
{
  ...
  (void)FsmSw_CommonLib_RandomBytes(optrand, SLH_DSA_SHAKE_256FSIMPLE_N);
                                                       ...
                                                       uint32 mlen, const uint8 *const pk)
{
  ...
  if (FsmSw_CommonLib_MemCmp(root, pub_root, SLH_DSA_SHAKE_256FSIMPLE_N) != 0u)
  {
    retVal = ERR_NOT_OK;
  }
                                               ...
                                               const uint8 *const sk)
{
  ...
  FsmSw_CommonLib_MemMove(&sm[SLH_DSA_SHAKE_256FSIMPLE_BYTES], m, mlen);
  *smlen = siglen + mlen;
                                                     ...
                                                     uint32 smlen, const uint8 *const pk)
{
  ...
  else
  {
    *mlen = smlen - SLH_DSA_SHAKE_256FSIMPLE_BYTES;
    ...
    FsmSw_CommonLib_MemMove(m, &sm[SLH_DSA_SHAKE_256FSIMPLE_BYTES], *mlen);
  }
  return retVal;
