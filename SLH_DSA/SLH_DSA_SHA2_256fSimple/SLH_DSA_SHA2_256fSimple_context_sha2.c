 ...
 ** @{ */
/** \addtogroup SLH_DSA_SHA2_256fSimple_context
 ** @{ */

/*====================================================================================================================*/
/** \file SLH_DSA_SHA2_256fSimple_context_sha2.c
* \brief  description of SLH_DSA_SHA2_256fSimple_context_sha2.c
*
* \details
*
*
...
/**********************************************************************************************************************/
static void slh_dsa_sha2_256fsimple_SeedState(slh_dsa_sha2_256f_ctx *ctx);
 ...
 *        and state_seeded_512, which can then be reused in SLH_DSA_SHA2_256fSimple_Thash.
 *
 * \param[in] slh_dsa_sha2_256f_ctx *ctx: t.b.d.
 *
 */
static void slh_dsa_sha2_256fsimple_SeedState(slh_dsa_sha2_256f_ctx *ctx)
{
  ...
  for (i = SLH_DSA_SHA2_256FSIMPLE_N; i < SLH_DSA_SHA512_BLOCK_BYTES; ++i)
  {
    block[i] = 0;
  }
  ...
  SLH_DSA_Sha512_IncInit(&ctx->state_seeded_512);
  SLH_DSA_Sha512_IncBlocks(&ctx->state_seeded_512, block, 1);
} // end: slh_dsa_sha2_256fsimple_SeedState
/**********************************************************************************************************************/
 ...
 *
 */
void SLH_DSA_SHA2_256fSimple_InitializeHashFunction(slh_dsa_sha2_256f_ctx *const ctx)
{
  slh_dsa_sha2_256fsimple_SeedState(ctx);
} // end: SLH_DSA_SHA2_256fSimple_InitializeHashFunction
