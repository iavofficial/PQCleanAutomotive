 ...
 ** @{ */
/** \addtogroup SLH_DSA_SHA2_256fSimple_thash
 ** @{ */

/*====================================================================================================================*/
/** \file SLH_DSA_SHA2_256fSimple_thash_sha2_simple.c
* \brief  description of SLH_DSA_SHA2_256fSimple_thash_sha2_simple.c
*
* \details
*
*
...
/*====================================================================================================================*/
/** 
 * \brief Takes an array of inblocks concatenated arrays of SLH_DSA_SHA2_256FSIMPLE_N bytes.
 *
 ...
 *
 */
void SLH_DSA_SHA2_256fSimple_Thash(uint8 *const out, const uint8 *const in, uint32 inblocks,
                                        const slh_dsa_sha2_256f_ctx *const ctx, const uint32 addr[8])
{
  uint8 outbuf[SLH_DSA_SHA256_OUTPUT_BYTES] = {0};
  sha256ctx sha2_state                            = {{0}};
  uint8 buf[SPX_SHA256_ADDR_BYTES + (SLH_DSA_SHA2_256FSIMPLE_THASH_BUF_LEN * SLH_DSA_SHA2_256FSIMPLE_N)] = {
      0};
  ...
  SLH_DSA_CommonLib_MemCpy(&buf[SPX_SHA256_ADDR_BYTES], in, inblocks * SLH_DSA_SHA2_256FSIMPLE_N);

  SLH_DSA_Sha256_IncFinalize(outbuf, &sha2_state, buf,
                           SPX_SHA256_ADDR_BYTES + (inblocks * SLH_DSA_SHA2_256FSIMPLE_N));
  SLH_DSA_CommonLib_MemCpy(out, outbuf, SLH_DSA_SHA2_256FSIMPLE_N);
} // end: SLH_DSA_SHA2_256fSimple_Thash
