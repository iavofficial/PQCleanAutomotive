  ...
  for (idx = 0; idx < SLH_DSA_UINT32_MAX_VALUE; idx++)
  {
    ...
    for (h = 0; h < SLH_DSA_UINT32_MAX_VALUE; h++)
    {
      ...
      if (h == tree_height)
      {
        ...
        FsmSw_CommonLib_MemCpy(root, &current[SLH_DSA_SHA2_256FSIMPLE_N], SLH_DSA_SHA2_256FSIMPLE_N);
        bStopFunc = TRUE;
      }
      ...
      {
        FsmSw_CommonLib_MemCpy(&auth_path[h * SLH_DSA_SHA2_256FSIMPLE_N], &current[SLH_DSA_SHA2_256FSIMPLE_N],
      ...
      FsmSw_CommonLib_MemCpy(&current[0], left, SLH_DSA_SHA2_256FSIMPLE_N);
    ...
    if (FALSE == bStopFunc)
    {
      ...
      FsmSw_CommonLib_MemCpy(&stack[h * SLH_DSA_SHA2_256FSIMPLE_N], &current[SLH_DSA_SHA2_256FSIMPLE_N],
                             SLH_DSA_SHA2_256FSIMPLE_N);
    }
  }
