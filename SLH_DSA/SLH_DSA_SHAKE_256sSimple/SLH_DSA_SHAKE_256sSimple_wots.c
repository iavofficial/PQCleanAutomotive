...
/**********************************************************************************************************************/
static void fsmsw_sphincsshake_256ssimple_wots_GenChain(uint8 *const out, const uint8 *const in, uint32 start,
                                                        uint32 steps, const sphincs_shake_256s_ctx *const ctx,
                                                        uint32 addr[8]);
static void fsmsw_sphincsshake_256ssimple_wots_BaseW(uint32 *const output, const sint32 out_len,
                                                     const uint8 *const input);
static void fsmsw_sphincsshake_256ssimple_wots_Checksum(uint32 *const csum_base_w, const uint32 *const msg_base_w);
/**********************************************************************************************************************/
...
} // end: fsmsw_sphincsshake_256ssimple_wots_GenChain
...
} // end: fsmsw_sphincsshake_256ssimple_wots_BaseW
...
static void fsmsw_sphincsshake_256ssimple_wots_Checksum(uint32 *const csum_base_w, const uint32 *const msg_base_w)
{
  ...
  fsmsw_sphincsshake_256ssimple_wots_BaseW(csum_base_w, (sint32)FSMSW_SPHINCSSHAKE_256SSIMPLE_WOTS_LEN2, csum_bytes);
} // end: fsmsw_sphincsshake_256ssimple_wots_Checksum
/**********************************************************************************************************************/
...
{
  fsmsw_sphincsshake_256ssimple_wots_BaseW(lengths, (sint32)FSMSW_SPHINCSSHAKE_256SSIMPLE_WOTS_LEN1, msg);
  fsmsw_sphincsshake_256ssimple_wots_Checksum(&lengths[FSMSW_SPHINCSSHAKE_256SSIMPLE_WOTS_LEN1], lengths);
                                                  ...
                                                  const sphincs_shake_256s_ctx *const ctx, uint32 addr[8])
{
  ...
  for (i = 0; i < FSMSW_SPHINCSSHAKE_256SSIMPLE_WOTS_LEN; i++)
  {
    ...
    fsmsw_sphincsshake_256ssimple_wots_GenChain(&pk[i * FSMSW_SPHINCSSHAKE_256SSIMPLE_N],
