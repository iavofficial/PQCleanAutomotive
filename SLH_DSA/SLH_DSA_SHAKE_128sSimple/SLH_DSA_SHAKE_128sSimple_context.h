 ...
 ** @{ */
/** \addtogroup SLH_DSA_SHAKE_128sSimple_context
 ** @{ */

/*====================================================================================================================*/
/** \file SLH_DSA_SHAKE_128sSimple_context.h
* \brief  Description of SLH_DSA_SHAKE_128sSimple_context.h
*
* \details
*
*
 ...
 *
 **********************************************************************************************************************/
#ifndef SLH_DSA_SHAKE_128SSIMPLE_CONTEXT_H
#define SLH_DSA_SHAKE_128SSIMPLE_CONTEXT_H
/**********************************************************************************************************************/
/* INCLUDES                                                                                                           */
/**********************************************************************************************************************/
...
typedef struct
{
  uint8 pub_seed[SLH_DSA_SHAKE_128SSIMPLE_N];
  uint8 sk_seed[SLH_DSA_SHAKE_128SSIMPLE_N];

} slh_dsa_shake_128s_ctx;
/**********************************************************************************************************************/
/* GLOBAL VARIABLES                                                                                                   */
/**********************************************************************************************************************/
...
/**********************************************************************************************************************/
void SLH_DSA_SHAKE_128sSimple_InitializeHashFunction(slh_dsa_shake_128s_ctx *const ctx);

void SLH_DSA_SHAKE_128sSimple_1FreeHashFunction(slh_dsa_shake_128s_ctx *const ctx);

#endif /* SLH_DSA_SHAKE_128SSIMPLE_CONTEXT_H */
