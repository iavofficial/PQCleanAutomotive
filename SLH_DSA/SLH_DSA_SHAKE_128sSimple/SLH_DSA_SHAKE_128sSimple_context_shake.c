...
/*====================================================================================================================*/
/** \file SLH_DSA_SHAKE_128sSimple_context_shake.c
* \brief  description of SLH_DSA_SHAKE_128sSimple_context_shake.c
*
* \details
*
*
...
*        operation.
*
* \param[out] slh_dsa_shake_128s_ctx *ctx : t.b.d.
*
*/
...
} // end: SLH_DSA_SHAKE_128sSimple_InitializeHashFunction
...
{
  (void)ctx;
} // end: SLH_DSA_SHAKE_128sSimple_1FreeHashFunction
