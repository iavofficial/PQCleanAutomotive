...
#define mgf1_X                FsmSw_SphincsSha2_256sSimple_MgF1_512
...
hence it is justified." */
void FsmSw_SphincsSha2_256sSimple_MgF1_512(uint8 *const out, uint32 outlen, const uint8 *const in, uint32 inlen)
{
...
} // end: FsmSw_SphincsSha2_256sSimple_MgF1_512
                                                   ...
                                                   const sphincs_sha2_256s_ctx *const ctx)
{
  ...
  FsmSw_CommonLib_MemSet(&buf[FSMSW_SPHINCSSHA2_256SSIMPLE_N], 0x5Cu,
                         SPX_SHAX_BLOCK_BYTES - FSMSW_SPHINCSSHA2_256SSIMPLE_N);
