                                                         ...
                                                         uint32 mlen, const uint8 *const sk)
{
  ...
  *siglen = FSMSW_SPHINCSSHAKE_192SSIMPLE_BYTES;
  ...
  return;
} // end: FsmSw_SphincsShake_192sSimple_Crypto_Sign_Signature
                                                     ...
                                                     uint32 smlen, const uint8 *const pk)
{
  ...
  *mlen = smlen - FSMSW_SPHINCSSHAKE_192SSIMPLE_BYTES;
  ...
  if (0 != FsmSw_SphincsShake_192sSimple_Crypto_Sign_Verify(sm, FSMSW_SPHINCSSHAKE_192SSIMPLE_BYTES,
                                                            &sm[FSMSW_SPHINCSSHAKE_192SSIMPLE_BYTES], *mlen, pk))
  {
    FsmSw_CommonLib_MemSet(m, 0, smlen);
    *mlen  = 0;
    retVal = ERR_NOT_OK;
