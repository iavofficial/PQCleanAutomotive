...
/**********************************************************************************************************************/
static void fsmsw_sphincsshake_128ssimple_fors_GenSk(uint8 *sk, const sphincs_shake_128s_ctx *ctx,
                                                     const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_128ssimple_fors_SkToLeaf(uint8 *leaf, const uint8 *sk, const sphincs_shake_128s_ctx *ctx,
                                                        const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincsshake_128ssimple_fors_GenLeafx1(uint8 *leaf, const sphincs_shake_128s_ctx *ctx,
                                                         uint32 addr_idx, void *info);
static void fsmsw_sphincsshake_128ssimple_fors_MessageToIndices(uint32 *indices, const uint8 *m);
/**********************************************************************************************************************/
