...
/**********************************************************************************************************************/
static void fsmsw_sphincssha2_128ssimple_crypto_sign_SeedKeyPair(uint8 *pk, uint8 *sk, const uint8 *seed);
/**********************************************************************************************************************/
                                                        ...
                                                        const uint8 *sk)
{
  ...
  const uint8 *sk_prf = &sk[FSMSW_SPHINCSSHA2_128SSIMPLE_N];
  const uint8 *pk     = &sk[2u * FSMSW_SPHINCSSHA2_128SSIMPLE_N];
...
{
  sphincs_sha2_128s_ctx ctx                                = {{0}};
  const uint8 *pub_root                                    = &pk[FSMSW_SPHINCSSHA2_128SSIMPLE_N];
  uint8 mhash[FSMSW_SPHINCSSHA2_128SSIMPLE_FORS_MSG_BYTES] = {0};
