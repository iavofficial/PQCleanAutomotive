...
/**********************************************************************************************************************/
static void fsmsw_sphincssha2_128fsimple_crypto_sign_SeedKeyPair(uint8 *pk, uint8 *sk, const uint8 *seed);
/**********************************************************************************************************************/
 ...
 *
 */
void FsmSw_SphincsSha2_128fSimple_Crypto_Sign_KeyPair(uint8 *pk, uint8 *sk)
{
...
designed for use by other systems that aim to integrate the Sphincs." */
void FsmSw_SphincsSha2_128fSimple_Crypto_Sign_Signature(uint8 *sig, uint32 *siglen, const uint8 *m, uint32 mlen,
                                                        const uint8 *sk)
{
  sphincs_sha2_128f_ctx ctx = {{0}};
...
/* polyspace +2 MISRA2012:8.7 [Justified:]"This is an interface function
designed for use by other systems that aim to integrate the Sphincs." */
uint8 FsmSw_SphincsSha2_128fSimple_Crypto_Sign_Verify(const uint8 *sig, uint32 siglen, const uint8 *m, uint32 mlen,
                                                      const uint8 *pk)
{
  sphincs_sha2_128f_ctx ctx                                = {{0}};
...
and avoids confusion with other functions. Therefore, this warning is a false positive." */
void FsmSw_SphincsSha2_128fSimple_Crypto_Sign(uint8 *sm, uint32 *smlen, const uint8 *m, uint32 mlen, const uint8 *sk)
{
  uint32 siglen = 0;
...
/* polyspace +2 MISRA2012:5.1 [Justified:]"The identifiers are distinct. The naming convention ensures clarity
and avoids confusion with other functions. Therefore, this warning is a false positive." */
uint8 FsmSw_SphincsSha2_128fSimple_Crypto_Sign_Open(uint8 *m, uint32 *mlen, const uint8 *sm, uint32 smlen,
                                                    const uint8 *pk)
{
  uint8 retVal = ERR_OK;
