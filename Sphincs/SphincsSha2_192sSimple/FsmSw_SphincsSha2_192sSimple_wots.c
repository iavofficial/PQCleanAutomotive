...
/**********************************************************************************************************************/
static void fsmsw_sphincssha2_192ssimple_wots_GenChain(uint8 *out, const uint8 *in, uint32 start, uint32 steps,
                                                       const sphincs_sha2_192s_ctx *ctx, uint32 addr[8]);
static void fsmsw_sphincssha2_192ssimple_wots_BaseW(uint32 *output, sint32 out_len, const uint8 *input);
static void fsmsw_sphincssha2_192ssimple_wots_Checksum(uint32 *csum_base_w, const uint32 *msg_base_w);
