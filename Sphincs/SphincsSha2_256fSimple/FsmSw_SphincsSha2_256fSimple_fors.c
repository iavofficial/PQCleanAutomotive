...
/**********************************************************************************************************************/
static void fsmsw_sphincssha2_256fsimple_fors_GenSk(uint8 *sk, const sphincs_sha2_256f_ctx *ctx,
                                                    const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincssha2_256fsimple_fors_SkToLeaf(uint8 *leaf, const uint8 *sk, const sphincs_sha2_256f_ctx *ctx,
                                                       const uint32 fors_leaf_addr[8]);
static void fsmsw_sphincssha2_256fsimple_fors_GenLeafx1(uint8 *leaf, const sphincs_sha2_256f_ctx *ctx, uint32 addr_idx,
                                                        void *info);
static void fsmsw_sphincssha2_256fsimple_fors_MessageToIndices(uint32 *indices, const uint8 *m);
/**********************************************************************************************************************/
...
and avoids confusion with other functions. Therefore, this warning is a false positive." */
void FsmSw_SphincsSha2_256fSimple_Fors_PkFromSig(uint8 *pk, const uint8 *sig, const uint8 *m,
